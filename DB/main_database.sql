...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2017 at 01:17 AM
...
INSERT INTO `categories` (`category_id`, `parent_id`, `category_title`, `category_text`, `category_text_ar`, `category_icon`, `showing_parent`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`, `modified_by`) VALUES
  (2, NULL, 'faculty', 'sss', '', '', 1, '2017-01-03 00:02:52', 1, '2017-01-03 10:02:52', 1, 0, NULL, NULL, 'admin'),
  (3, 2, 'study_year', NULL, NULL, NULL, 1, '2016-12-25 10:41:28', 1, '2016-12-16 00:25:38', 1, 0, NULL, NULL, 'admin'),
  (4, 3, 'subject', NULL, NULL, NULL, 1, '2016-12-25 10:41:36', 1, '2016-12-16 00:26:15', 1, 0, NULL, NULL, 'admin'),
  (6, 4, 'lesson', NULL, NULL, NULL, 1, '2017-01-01 22:19:26', 1, '2017-01-01 08:19:26', 1, 0, NULL, NULL, 'admin'),
  (7, NULL, 'students', NULL, NULL, NULL, 1, '2016-12-30 17:18:25', 1, '2016-12-30 03:18:25', 1, 0, NULL, NULL, 'admin'),
  (8, NULL, 'teachers', NULL, NULL, NULL, 1, '2017-01-01 19:42:44', 1, '2017-01-01 05:42:44', 1, 0, NULL, NULL, 'admin'),
  (9, NULL, 'teacher_subject', NULL, NULL, NULL, 1, '2016-12-25 10:41:57', 1, '2016-12-16 00:29:38', 1, 0, NULL, NULL, 'admin'),
  (10, 7, 'student_subject', NULL, NULL, NULL, 1, '2016-12-30 21:24:15', 1, '2016-12-30 07:24:15', 1, 0, NULL, NULL, 'admin'),
  (11, 6, 'lesson_questions', NULL, NULL, NULL, 0, '2017-01-02 13:56:27', 1, '2017-01-01 23:56:27', 1, 0, NULL, NULL, 'admin'),
  (12, 6, 'lesson_files', NULL, NULL, NULL, 1, '2016-12-25 10:42:05', 1, '2016-12-16 01:27:16', 1, 0, NULL, NULL, 'admin'),
  ...
  (14, 4, 'exam', NULL, NULL, NULL, 1, '2017-01-02 05:01:27', 1, '2017-01-02 03:01:27', 1, 0, NULL, NULL, 'admin'),
  (15, 4, 'exam_questions', NULL, NULL, NULL, 1, '2017-01-02 14:52:45', 1, '2017-01-02 00:52:45', 1, 0, NULL, NULL, 'admin'),
  (16, 13, 'questions_template', NULL, NULL, NULL, 1, '2017-01-02 15:14:14', 1, '2017-01-02 01:14:14', 1, 0, NULL, NULL, 'admin'),
  (17, NULL, 'general_informations', NULL, NULL, NULL, 1, '2016-12-29 12:00:40', 1, '2016-12-28 23:00:40', 1, 0, NULL, NULL, 'admin'),
  (18, NULL, 'New_Events', NULL, NULL, NULL, 1, '2016-12-30 06:23:21', 1, '2016-12-30 05:23:21', 1, 0, NULL, NULL, 'admin'),
  (19, NULL, 'user', NULL, NULL, NULL, 0, '2016-12-30 15:17:59', 1, '2016-12-30 03:17:59', 1, 0, NULL, NULL, 'admin');
...
INSERT INTO `menus` (`menu_id`, `parent_id`, `category_id`, `menu_position`, `menu_for`, `icon`, `is_private`, `item_id`, `menu_title`) VALUES
  ...
  (30, NULL, NULL, 'left', 'Admin', 'spy icon', 1, NULL, 'Teachers'),
  (31, 30, 9, 'left', 'Admin', NULL, 1, NULL, 'Teachers And Subjects'),
  (32, 30, 8, 'left', 'Admin', NULL, 1, NULL, 'See All Teachers'),
  (33, NULL, NULL, 'left', 'Admin', NULL, 1, NULL, 'Students'),
  (34, 33, 7, 'left', 'Admin', NULL, 1, NULL, 'See All Students'),
  (35, NULL, NULL, 'left', 'Admin', NULL, 1, NULL, 'General Info'),
  (36, 35, 17, 'left', 'Admin', NULL, 1, NULL, 'View All informations'),
  (37, 35, 17, 'left', 'Admin', NULL, 1, NULL, 'Add information'),
  (38, NULL, NULL, 'left', 'Admin', NULL, 1, NULL, 'Events'),
  (39, 38, 18, 'left', 'Admin', NULL, 1, NULL, 'View All Events'),
  (40, 38, 18, 'left', 'Admin', NULL, 1, NULL, 'Add event'),
  (42, 33, 10, 'left', 'Admin', NULL, 1, NULL, 'Students Marks'),
  (43, NULL, 10, 'left', 'Student', NULL, 1, NULL, 'My Subjects'),
  (44, NULL, 10, 'left', 'Student', NULL, 1, NULL, 'My Marks'),
  (45, NULL, 9, 'left', 'Teacher', NULL, 1, NULL, 'my subjects');
...
INSERT INTO `values` (`value_id`, `item_id`, `field_id`, `language_id`, `value`) VALUES
  ...
  (4, 1, 203, 8, 'شرح كلية الهندسة المعلوماتية'),
...
ALTER TABLE `menu_language`
  ADD CONSTRAINT `menu_language_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `menus` (`menu_id`) ON DELETE CASCADE,
