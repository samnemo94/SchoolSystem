...
(6, 4, 'lesson', 1, '2016-12-25 10:41:42', 1, '2016-12-16 01:04:24', 1, 0, NULL, NULL, 'admin'),
(7, NULL, 'students', 1, '2016-12-30 17:18:25', 1, '2016-12-30 03:18:25', 1, 0, NULL, NULL, 'admin'),
(8, NULL, 'teachers', 1, '2016-12-25 10:41:52', 1, '2016-12-16 00:28:21', 1, 0, NULL, NULL, 'admin'),
...
(21, 'first_name', 8, 'varchar', '', 0, 0, 1),
(22, 'last_name', 8, 'varchar', '', 0, 0, 1),
(23, 'age', 8, 'int', '', 0, 0, 1),
(24, 'address', 8, 'text', '', 0, 0, 1),
(25, 'phone', 8, 'varchar', '', 0, 1, 1),
(26, 'photo', 8, 'image', '', 0, 1, 1),
(28, 'teacher_id', 9, 'foreign_key', '8', 0, 0, 1),
(29, 'subject_id', 9, 'foreign_key', '4', 0, 0, 1),
(30, 'form_date', 9, 'date', '', 0, 0, 1),
(31, 'to_date', 9, 'date', '', 0, 0, 1),
(39, 'title', 6, 'varchar', '', 1, 0, 1),
(40, 'description', 6, 'text', '', 1, 0, 1),
(41, 'image', 6, 'image', '', 0, 0, 0),
(42, 'subject', 6, 'foreign_key', '4', 0, 0, 1),
(43, 'lesson_id', 6, 'int', '', 0, 0, 1),
(44, 'file_id', 12, 'int', '', 0, 0, 1),
(45, 'lesson_id', 12, 'foreign_key', '6', 0, 0, 1),
(46, 'file_link', 12, 'file', '', 0, 0, 1),
(47, 'template_id', 13, 'int', '', 0, 0, 1),
(48, 'subject_id', 13, 'foreign_key', '4', 0, 0, 1),
...
(346, 70, 111, NULL, '67'),
(347, 62, 21, NULL, 'omar'),
(348, 62, 22, NULL, 'alsabbagh'),
(349, 62, 24, NULL, 'damascus-almidan'),
(350, 62, 23, NULL, '30'),
(351, 62, 25, NULL, '0987654321'),
(352, 62, 26, NULL, '../../common/web/uploads/1483098081t1.png'),
(353, 63, 21, NULL, 'taym'),
(354, 63, 22, NULL, 'alhulaibi'),
(355, 63, 24, NULL, 'damascus'),
(356, 63, 23, NULL, '30'),
(357, 63, 25, NULL, '098765432'),
(358, 63, 26, NULL, '../../common/web/uploads/1483098201t2.jpg'),
(359, 64, 21, NULL, 'haya'),
(360, 64, 22, NULL, 'hamoud'),
(361, 64, 24, NULL, 'damascus'),
(362, 64, 23, NULL, '22'),
(363, 64, 25, NULL, '098765543'),
(364, 64, 26, NULL, '../../common/web/uploads/1483098254t3.png'),
(365, 62, 117, NULL, '1'),
(366, 63, 117, NULL, '1'),
(367, 64, 117, NULL, '1'),
(368, 71, 21, NULL, 'maya'),
(369, 71, 22, NULL, 'hamoud'),
(370, 71, 23, NULL, '25'),
(371, 71, 24, NULL, '<p>damascus-kafarsose</p>'),
(372, 71, 25, NULL, '0987654321'),
(373, 71, 26, NULL, '../../common/web/uploads/1483170365t3.png'),
(374, 71, 117, NULL, '1'),
(375, 72, 28, NULL, '62'),
(376, 72, 29, NULL, '22'),
