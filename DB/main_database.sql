...
(52, 'title', 2, 'varchar', '', 1, 0, 1),
(53, 'description', 2, 'text', '', 1, 0, 1),
(54, 'image', 2, 'image', '', 0, 1, 1),
(55, 'title', 3, 'varchar', '', 1, 0, 1),
(56, 'description', 3, 'text', '', 1, 0, 1),
(57, 'faculty', 3, 'foreign_key', '2', 0, 0, 1),
(58, 'description', 4, 'text', '', 1, 0, 1),
(59, 'title', 4, 'varchar', '', 1, 0, 1),
(60, 'image', 4, 'image', '', 0, 1, 1),
(61, 'study_year', 4, 'foreign_key', '3', 0, 0, 1),
(62, 'subject_id', 4, 'int', '', 0, 0, 1),
(67, 'student_id', 7, 'int', '', 0, 0, 1),
(68, 'first_name', 7, 'varchar', '', 0, 0, 1),
(69, 'last_name', 7, 'varchar', '', 0, 0, 1),
(70, 'age', 7, 'int', '', 0, 0, 1),
(71, 'address', 7, 'text', '', 0, 0, 1),
(72, 'year', 7, 'int', '', 0, 0, 1),
(73, 'phone', 7, 'varchar', '', 0, 1, 1),
(74, 'photo', 7, 'image', '', 0, 1, 1),
(75, 'teacher_id', 8, 'int', '', 0, 0, 1),
(76, 'first_name', 8, 'varchar', '', 0, 0, 1),
(77, 'last_name', 8, 'varchar', '', 0, 0, 1),
(78, 'age', 8, 'int', '', 0, 0, 1),
(79, 'address', 8, 'text', '', 0, 0, 1),
(80, 'phone', 8, 'varchar', '', 0, 1, 1),
(81, 'photo', 8, 'image', '', 0, 1, 1),
(82, 'teacher_subject_id', 9, 'int', '', 0, 0, 1),
(83, 'teacher_id', 9, 'foreign_key', '8', 0, 0, 1),
(84, 'subject_id', 9, 'foreign_key', '4', 0, 0, 1),
(85, 'form_date', 9, 'date', '', 0, 0, 1),
(86, 'to_date', 9, 'date', '', 0, 0, 1),
(87, 'student_subject_id', 10, 'int', '', 0, 0, 1),
(88, 'student_id', 10, 'foreign_key', '7', 0, 0, 1),
(89, 'subject_id', 10, 'foreign_key', '4', 0, 0, 1),
(90, 'registration_date', 10, 'date_time', '', 0, 0, 1),
(91, 'lessons_finished', 10, 'int', '', 0, 1, 0),
(92, 'exam_mark', 10, 'double', '', 0, 1, 0),
(93, 'teacher_evaluate', 10, 'varchar', '', 0, 1, 0),
(94, 'title', 6, 'varchar', '', 1, 0, 1),
(95, 'description', 6, 'text', '', 1, 0, 1),
(96, 'image', 6, 'image', '', 0, 0, 0),
(97, 'subject', 6, 'foreign_key', '4', 0, 0, 1),
(98, 'lesson_id', 6, 'int', '', 0, 0, 1),
(106, 'file_id', 12, 'int', '', 0, 0, 1),
(107, 'lesson_id', 12, 'foreign_key', '6', 0, 0, 1),
(108, 'file_link', 12, 'file', '', 0, 0, 1),
(109, 'template_id', 13, 'int', '', 0, 0, 1),
(110, 'subject_id', 13, 'foreign_key', '4', 0, 0, 1),
(111, 'exam_id', 14, 'int', '', 0, 0, 1),
(112, 'subject_id', 14, 'foreign_key', '4', 0, 0, 1),
(113, 'template_id', 14, 'foreign_key', '13', 0, 0, 1),
(114, 'exam_date', 14, 'date_time', '', 0, 0, 1),
(115, 'question_id', 15, 'int', '', 0, 0, 1),
(116, 'question_text', 15, 'text', '', 1, 0, 1),
(117, 'choice1', 15, 'text', '', 1, 0, 1),
(118, 'choice2', 15, 'text', '', 1, 0, 1),
(119, 'choice3', 15, 'text', '', 1, 0, 1),
(120, 'choice4', 15, 'text', '', 1, 0, 1),
(121, 'question_id', 16, 'foreign_key', '15', 0, 0, 1),
(122, 'template_id', 16, 'foreign_key', '', 0, 0, 1),
(123, 'mark', 16, 'double', '', 0, 0, 1),
(124, 'order', 16, 'int', '', 0, 0, 1),
(125, 'question_id', 11, 'int', '', 0, 0, 1),
(126, 'lesson_id', 11, 'foreign_key', '6', 0, 0, 1),
(127, 'question_text', 11, 'text', '', 1, 0, 1),
(128, 'choice1', 11, 'text', '', 1, 0, 1),
(129, 'choice2', 11, 'text', '', 1, 0, 1),
(130, 'choice3', 11, 'varchar', '', 1, 0, 1),
(131, 'choice4', 11, 'text', '', 1, 0, 1);
...
--
ALTER TABLE `fields`
  MODIFY `field_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
--
...
--
ALTER TABLE `menu_language`
  MODIFY `menu_language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `values`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
--
