...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 17, 2017 at 09:09 PM
...
CREATE TABLE `categories` (
  ...
  `category_text_ar` varchar(255) DEFAULT NULL,
...
INSERT INTO `categories` (`category_id`, `parent_id`, `category_title`, `category_text`, `category_text_ar`, `category_icon`, `showing_parent`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`, `modified_by`) VALUES
(2, NULL, 'faculty', 'Faculty', 'الكلية', 'student icon', 1, '2017-01-03 05:44:25', 1, '2017-01-03 10:02:52', 1, 0, NULL, NULL, 'admin'),
(3, 2, 'study_year', 'Study Year', 'السنة الدراسية', 'calendar outline icon', 1, '2017-01-03 05:44:41', 1, '2016-12-16 00:25:38', 1, 0, NULL, NULL, 'admin'),
(4, 3, 'subject', 'Subject', 'المادة', 'book icon', 1, '2017-01-03 05:44:46', 1, '2016-12-16 00:26:15', 1, 0, NULL, NULL, 'admin'),
(6, 4, 'lesson', 'Lessons', 'الدرس', 'file text outline icon', 1, '2017-01-03 05:44:53', 1, '2017-01-01 08:19:26', 1, 0, NULL, NULL, 'admin'),
(7, NULL, 'students', 'Students', 'الطلاب', 'student icon', 1, '2017-01-03 05:44:57', 1, '2016-12-30 03:18:25', 1, 0, NULL, NULL, 'admin'),
(8, NULL, 'teachers', 'Teachers', 'المعلمين', 'users icon', 1, '2017-01-03 05:45:01', 1, '2017-01-01 05:42:44', 1, 0, NULL, NULL, 'admin'),
(9, NULL, 'teacher_subject', 'Subject and Teacher', 'المعلمين والمواد', 'folder outline icon', 1, '2017-01-03 05:45:10', 1, '2016-12-16 00:29:38', 1, 0, NULL, NULL, 'admin'),
(10, 7, 'student_subject', 'Subject and Student', 'الطالب و المواد', 'folder outline icon', 1, '2017-01-03 05:45:22', 1, '2016-12-30 07:24:15', 1, 0, NULL, NULL, 'admin'),
(11, 6, 'lesson_questions', 'Lesson Question', 'سؤال الدرس', 'sticky note outline icon', 0, '2017-01-03 05:45:36', 1, '2017-01-01 23:56:27', 1, 0, NULL, NULL, 'admin'),
(12, 6, 'lesson_files', 'Lesson Files', 'ملفات الدرس', 'file icon', 1, '2017-01-03 05:45:41', 1, '2016-12-16 01:27:16', 1, 0, NULL, NULL, 'admin'),
(13, 4, 'exam_template', 'Exam Template', 'النماذج الامتحانية', 'sitemap icon', 1, '2017-01-03 00:00:30', 1, '2017-01-03 10:00:30', 1, 0, NULL, NULL, 'admin'),
(14, 4, 'exam', 'Exam', 'امتحان', 'file text icon', 1, '2017-01-03 05:45:48', 1, '2017-01-02 03:01:27', 1, 0, NULL, NULL, 'admin'),
(15, 4, 'exam_questions', 'Exam Questions', 'سؤال امتحان', 'file icon', 1, '2017-01-03 05:46:07', 1, '2017-01-02 00:52:45', 1, 0, NULL, NULL, 'admin'),
(16, 13, 'questions_template', 'Questions Template', 'سؤال نموذج', 'file icon', 1, '2017-01-03 05:46:24', 1, '2017-01-02 01:14:14', 1, 0, NULL, NULL, 'admin'),
(17, NULL, 'general_informations', 'General Informations', 'معلومات عامة', 'list layout icon', 1, '2017-01-03 05:46:33', 1, '2016-12-28 23:00:40', 1, 0, NULL, NULL, 'admin'),
(18, NULL, 'New_Events', 'New Events', 'احداث جديدة', 'list layout icon', 1, '2017-01-03 05:46:42', 1, '2016-12-30 05:23:21', 1, 0, NULL, NULL, 'admin'),
(19, NULL, 'user', 'User', 'مستخدم', 'user icon', 0, '2017-01-03 05:46:44', 1, '2016-12-30 03:17:59', 1, 0, NULL, NULL, 'admin');
...
(200, 'subject_id', NULL, 13, 'foreign_key', '4', 0, 0, 0),
(201, 'title', NULL, 13, 'varchar', '', 1, 0, 1),
(202, 'title', NULL, 2, 'varchar', '', 1, 0, 1),
(203, 'description', NULL, 2, 'text', '', 1, 0, 1),
(204, 'image', NULL, 2, 'image', '', 0, 1, 1);
...
(108, 16, '2017-01-02 22:40:07', 1, '2017-01-03 00:40:07', 13, 0, NULL, NULL, 'admin'),
(109, 10, '2017-01-02 22:56:23', 1, '2017-01-03 00:56:23', 10, 0, NULL, NULL, 'admin'),
(110, 7, '2017-01-03 05:18:31', 14, '2017-01-03 05:18:31', NULL, 0, NULL, NULL, 'admin'),
(111, 10, '2017-01-03 05:19:48', 1, '2017-01-03 07:19:48', 14, 0, NULL, NULL, 'admin'),
(112, 16, '2017-01-03 05:25:09', 1, '2017-01-03 07:25:09', 13, 0, NULL, NULL, 'admin'),
(113, 16, '2017-01-03 05:25:19', 1, '2017-01-03 07:25:19', 13, 0, NULL, NULL, 'admin');
...
INSERT INTO `menus` (`menu_id`, `parent_id`, `category_id`, `menu_position`, `menu_for`, `icon`, `is_private`, `item_id`, `menu_title`) VALUES
(1, NULL, 2, 'top', NULL, NULL, 1, NULL, 'faculties '),
(4, 1, NULL, 'top', NULL, NULL, 1, 1, 'ite'),
(5, 1, NULL, 'top', NULL, NULL, 1, 2, 'mte'),
(6, 1, NULL, 'top', NULL, NULL, 1, 3, 'medicin'),
(7, 4, NULL, 'top', NULL, NULL, 1, 6, 'ite-1y'),
(8, 4, NULL, 'top', NULL, NULL, 1, 7, 'ite-2y'),
(9, 4, NULL, 'top', NULL, NULL, 1, 8, 'ite-3y'),
(10, 4, NULL, 'top', NULL, NULL, 1, 9, 'ite-4y'),
(11, 4, NULL, 'top', NULL, NULL, 1, 10, 'ite-5y'),
(12, 5, NULL, 'top', NULL, NULL, 1, 11, 'mte-1y'),
(13, 5, NULL, 'top', NULL, NULL, 1, 12, 'mte-2y'),
(14, 5, NULL, 'top', NULL, NULL, 1, 13, 'mte-3y'),
(15, 5, NULL, 'top', NULL, NULL, 1, 14, 'mte-4y'),
(16, 5, NULL, 'top', NULL, NULL, 1, 15, 'mte-5y'),
(17, 6, NULL, 'top', NULL, NULL, 1, 16, 'medicin-1y'),
(18, 6, NULL, 'top', NULL, NULL, 1, 17, 'medicin-2y'),
(19, 6, NULL, 'top', NULL, NULL, 1, 18, 'medicin-3y'),
(20, 6, NULL, 'top', NULL, NULL, 1, 19, 'medicin-4y'),
(21, 6, NULL, 'top', NULL, NULL, 1, 20, 'medicin-5y'),
(22, 6, NULL, 'top', NULL, NULL, 1, 21, 'medicin-6y'),
(23, NULL, 17, 'top', NULL, NULL, 0, NULL, 'General Informations'),
(24, 23, NULL, 'top', NULL, NULL, 0, 54, 'about_university'),
(25, 23, NULL, 'top', NULL, NULL, 0, 53, 'rector\'s_message'),
(26, 23, NULL, 'top', NULL, NULL, 0, 55, 'mission&vission'),
(27, 23, NULL, 'top', NULL, NULL, 0, 56, 'FAQS'),
(28, 23, NULL, 'top', NULL, NULL, 0, 57, 'Contact-Info'),
(29, NULL, 18, 'top', NULL, NULL, 0, NULL, 'New Events'),
(30, NULL, NULL, 'left', 'Admin', 'users icon', 1, NULL, 'Teachers'),
(31, 30, 9, 'left', 'Admin', 'book icon', 1, NULL, 'Teachers And Subjects'),
(32, 30, 8, 'left', 'Admin', 'users icon', 1, NULL, 'See All Teachers'),
(33, NULL, NULL, 'left', 'Admin', 'student icon', 1, NULL, 'Students'),
(34, 33, 7, 'left', 'Admin', 'users icon', 1, NULL, 'See All Students'),
(35, NULL, NULL, 'left', 'Admin', 'list layout icon"', 1, NULL, 'General Info'),
(36, 35, 17, 'left', 'Admin', 'browser icon', 1, NULL, 'View All informations'),
(37, 35, 17, 'left', 'Admin', 'plus icon', 1, NULL, 'Add information'),
(38, NULL, NULL, 'left', 'Admin', 'list layout icon', 1, NULL, 'Events'),
(39, 38, 18, 'left', 'Admin', 'browser icon', 1, NULL, 'View All Events'),
(40, 38, 18, 'left', 'Admin', 'plus icon', 1, NULL, 'Add event'),
(42, 33, 10, 'left', 'Admin', 'grid layout icon', 1, NULL, 'Students Marks'),
(43, NULL, 10, 'left', 'Student', 'book icon', 1, NULL, 'My Subjects'),
(44, NULL, 10, 'left', 'Student', 'grid layout icon', 1, NULL, 'My Marks'),
(45, NULL, 9, 'left', 'Teacher', 'book icon', 1, NULL, 'my subjects');
...
(66, 45, 8, 'موادي'),
(67, 45, 9, 'My Subjects'),
(68, 23, 9, 'General Informations'),
(69, 24, 9, 'About Univercity'),
(70, 25, 9, 'Rector\'s Message'),
(71, 26, 9, 'Vision And Mission'),
(72, 27, 9, 'FAQ'),
(73, 28, 9, 'Contact Info'),
(74, 29, 9, 'Events'),
(75, 30, 9, 'Teachers'),
(76, 31, 9, 'Assign Subjects'),
(77, 32, 9, 'All Teachers'),
(78, 33, 9, 'Students'),
(79, 34, 9, 'All Students'),
(80, 35, 9, 'General Informations'),
(81, 36, 9, 'View All'),
(82, 37, 9, 'Add New'),
(83, 38, 9, 'Events'),
(84, 39, 9, 'View'),
(85, 40, 9, 'Add'),
(86, 42, 9, 'Students Marks'),
(87, 43, 9, 'My Subjects'),
(88, 44, 9, 'My Marks');
...
(14, 2, 'std123', 'Xp9XoWKX-KNecsKHXsveH1_wnmiXze0V', '$2y$13$EqqBVXvJ8aMKj1tawsZpwexwaFcwmjj8hHzlx.oXImqso61xw9cjC', NULL, 'nnssllqqppp@gmail.com', 10, 1483427911, 1483427911);
...
(2, 1, 202, 8, 'كلية الهندسة المعلوماتية'),
(3, 1, 202, 9, 'Faculty Of Information Technology'),
(4, 1, 203, 8, 'تأسست هذه الكلية عام ال 2000 برعاية العديد من أعضاء الهيئة التدريسية الكفؤ و الذين تلقوا تعليمهم في المعهد العالي للبحوث التطبيقية . تتميز هذه الكلية بموقعها المميز في ربوع الهمك بين العديد من كليات الهندسة الأخرى لتمتزج هذه العلوم سوية'),
(5, 1, 203, 9, 'Description About IT'),
(6, 1, 204, NULL, '../../common/web/uploads/fit.jpg'),
(7, 2, 202, 8, 'كلية الهندسة المدنية'),
(8, 2, 202, 9, 'Faculty Of Civil Engineering'),
(9, 2, 203, 8, 'شرح كلية الهندسة المدنية'),
(10, 2, 203, 9, 'Description About CE'),
(11, 2, 204, NULL, '../../common/web/uploads/19-2807.jpg'),
(12, 3, 202, 8, 'كلية الطب البشري'),
(13, 3, 202, 9, 'Faculty Of Midicin'),
(14, 3, 203, 8, 'شرح كلية الطب البشري'),
(15, 3, 203, 9, 'Description About HM'),
(16, 3, 204, NULL, '../../common/web/uploads/medicine.jpg'),
...
(192, 37, 10, NULL, '15'),
(199, 41, 202, 8, 'يربسيبسي'),
(200, 41, 203, 8, 'يسشبسيبسيب'),
(201, 41, 204, 8, 'stock-photo-113916201.jpg'),
(202, 42, 202, 8, 'كلية جديدة جدا'),
(203, 42, 203, 8, '<p>وصف طويل جدا للكلية الجديدة جدا</p>'),
(204, 42, 204, 8, '../../common/web/uploads/1483115154'),
(205, 44, 202, 8, 'كلية جديدة ثانية'),
(206, 44, 203, 8, 'وصف كلية جديدة ثانية'),
(207, 44, 204, 8, '../../common/web/uploads/speeeeed.png'),
(208, 45, 202, 8, 'Sas'),
(209, 45, 203, 8, 'DSdcsad'),
(210, 45, 204, 8, '../../common/web/uploads/148034807814732232_520972304778345_3121256020441722779_n.jpg'),
(213, 47, 202, 8, 'كلية الصيدلة'),
(214, 47, 203, 8, 'سيبسيبلي سيبلسي بلسث بسيب\r\nسيبسي\r\n بسي\r\nب '),
(215, 47, 202, 9, 'Faculty Of Pharmacy'),
(216, 47, 203, 9, 'FASDcf Ad adf ad ad'),
(217, 47, 204, NULL, '../../common/web/uploads/14803965931-8f9-275.jpg'),
(218, 48, 202, 8, 'كلية الصيدلة'),
(219, 48, 203, 8, 'سيبسيبلي سيبلسي بلسث بسيب\r\nسيبسي\r\n بسي\r\nب '),
(220, 48, 202, 9, 'Faculty Of Pharmacy'),
(221, 48, 203, 9, 'FASDcf Ad adf ad ad'),
(222, 48, 204, NULL, '../../common/web/uploads/14803972461-8f9-275.jpg'),
...
(257, 58, 84, 8, '<p>تم صدور برامج امتحان الفصل الأول لعام 2016-2017 لجميع الكليات و السنوات.</p>'),
(258, 58, 83, 9, 'publishing the exam program 2016-2017'),
(259, 58, 84, 9, '<p>published the first semester exam program for the year 2016-2017 for all colleges and years.</p>'),
(260, 59, 83, 8, 'تمديد موعد انتهاء التسجيل'),
(261, 59, 84, 8, '<p>يمدد موعد انتهاء التسجيل للطلاب الجدد و القدامى الى التاريخ : 1/1/2017</p>'),
(262, 59, 83, 9, 'Extend the registration expiration date.'),
(263, 59, 84, 9, '<p>Extend the registration deadline for new and old students to date: 01/01/2017</p>'),
(264, 60, 83, 8, 'إعلان افتتـاح المعهـد التقـاني للحاسوب في الجامعـة الافتـراضيـة السـوريـة'),
(265, 60, 84, 8, '<p>تعـلـن الجامعة الافتراضية السـورية عن افتتاح "المعهد التقاني للحاسوب TIC " اختصاص برمجيات ونظم المعلومات لطلاب حملة الشهادة الثانوية بمعـدل 50% ومافوق وذلـك للثانـويات التالـية: العامة : الفرع العـلمي الصنـاعية والمهنية : تقنيات الحاسوب - المعلوماتية - البرمجة وأنظمة التشغيل - صيانة الحواسب والتجهيزات الحاسوبية - الشبكات الحاسوبية- كهرباء الطيران - ميكانيك الطيران - ميكانيك السيارات - التقنيات الالكترونية - التقنيات الكهربائية - كهرباء والكترون المركبات - ميكانيك المركبات - التكييف والتبريد - المحركـات والآليات - التدفئة والتمديدات - الكهرباء - التلمذة الصناعية - التصنيع الميكانيكي - الآليات والمعدات الزراعية - آلات زراعية - صيانة الآلات والمعدات الزراعية - ميكاترونيكس- مهن نفطية (أجهزة القياس والتحكم - كهرباء صناعية) - صيانة الأجهزة الطبية - كافـة الثانـويـات الصناعيـة التقـانيـة- تقنيات الحاسوب - المعلوماتية - البرمجة وأنظمة التشغيل - صيانة الحواسب والتجهيزات الحاسوبية - الشبكات الحاسوبية مدة الدراســة : سـنتان كحـد أدنـى</p>'),
(266, 60, 83, 9, 'opening Technical Institute for the computer in the Syrian Virtual University'),
(267, 60, 84, 9, '<p>Syrian Virtual University announces the opening of "Technical Institute for Computer TIC" the jurisdiction of the software and information systems for students of high school graduates at a rate of 50% and above For the following high schools: public: the scientific branch Industrial and professional: computer techniques - Informatics - programming and operating systems - maintenance and computer equipment computers - Alhessobh- networks Aviation electricity - Mechanical flight - car mechanics - the electronic technology - electrical engineering - Electricity and Electron vehicles - Mechanical vehicles - air conditioning and refrigeration - motor vehicles - heating and extensions - Electricity - apprenticeships - mechanical manufacturing - machinery and agricultural equipment - agricultural machinery - maintenance of agricultural machinery and equipment - Makatronieks- oil occupations (measurement and control devices - Industrial electricity) - Medical equipment maintenance - all industrial high schools, technological - computer technology - Informatics - programming and operating systems - maintenance of computers and computer equipment - computer networks &nbsp;Duration of study: two years minimum</p>'),
(268, 58, 85, NULL, '../../common/web/uploads/14834284491483098254t3.png'),
(269, 59, 85, NULL, '../../common/web/uploads/14834284731483098201t2.jpg'),
(270, 60, 85, NULL, '../../common/web/uploads/14834284791483098081t1.png'),
(271, 44, 202, 8, 'كلية جديدة ثثثانية'),
(272, 44, 203, 8, '<p>وصف كلية جديدة ثثثانية</p>'),
(273, 44, 202, 9, 'Tanie'),
(274, 44, 203, 9, '<p>Tanie Desc</p>'),
(275, 44, 204, NULL, '../../common/web/uploads/1483099713'),
(276, 44, 202, 8, 'كلية جديدة ثثثانية'),
(277, 44, 203, 8, '<p>وصف كلية جديدة ثثثانية</p>'),
(278, 44, 202, 9, 'Tanie'),
(279, 44, 203, 9, '<p>Tanie Desc</p>'),
(280, 44, 204, NULL, '../../common/web/uploads/1483099743'),
(281, 44, 202, 8, 'كلية جديدة ثثثانية'),
(282, 44, 203, 8, '<p>وصف كلية جديدة ثثثانية</p>'),
(283, 44, 202, 9, 'Tanie'),
(284, 44, 203, 9, '<p>Tanie Desc</p>'),
(285, 44, 204, NULL, '../../common/web/uploads/1483099743'),
(286, 42, 202, 9, 'Bbb'),
(287, 42, 203, 9, '<p>KLNL</p>'),
...
(581, 107, 143, NULL, '32'),
(582, 108, 196, NULL, '103'),
(583, 108, 198, NULL, '12'),
(584, 108, 199, NULL, '1'),
(585, 108, 197, NULL, '106'),
(586, 109, 112, NULL, '32'),
(587, 109, 113, NULL, '2017-01-01T01:00'),
(588, 109, 111, NULL, '67'),
(589, 110, 88, NULL, 'Samy'),
(590, 110, 89, NULL, 'Al Naimy'),
(591, 110, 90, NULL, '22'),
(592, 110, 91, NULL, 'Mezzah'),
(593, 110, 92, NULL, '1994'),
(594, 110, 93, NULL, '+963967274218'),
(595, 110, 118, NULL, '1'),
(596, 110, 94, NULL, '../../common/web/uploads/14834279111483015931sami.jpg'),
(597, 110, 95, NULL, '14'),
(598, 110, 95, NULL, '14'),
(599, 111, 112, NULL, '32'),
(600, 111, 113, NULL, '2017-01-01T02:00'),
(601, 111, 111, NULL, '110'),
(602, 112, 196, NULL, '104'),
(603, 112, 198, NULL, '14'),
(604, 112, 199, NULL, '2'),
(605, 112, 197, NULL, '106'),
(606, 113, 196, NULL, '105'),
(607, 113, 198, NULL, '1'),
(608, 113, 199, NULL, '3'),
(609, 113, 197, NULL, '106'),
(610, 111, 115, NULL, '3');
...
--
ALTER TABLE `fields`
  MODIFY `field_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
--
...
--
ALTER TABLE `menu_language`
  MODIFY `menu_language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
--
...
--
ALTER TABLE `values`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=611;
--
