!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0}), n(2);
        var r = n(1), i = {Sidebar: r.Sidebar, Scrollable: r.Scrollable};
        ...
        !function (e, r) {
            ...
            return function (t) {
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), n(70);
                var i = n(27), o = r(i), s = n(26), a = r(s), c = {Sidebar: new o["default"], Scrollable: a["default"]};
                e["default"] = c, t.exports = e["default"]
            }, function (t, e, n) {
                var r = n(54)("wks"), i = n(62), o = n(2).Symbol;
                ...
                var r = n(2), i = n(4), o = n(6), s = "prototype", a = function (t, e, n) {
                    var c, u, l, f = t & a.F, h = t & a.G, p = t & a.S, d = t & a.P, v = t & a.B, b = t & a.W, y = h ? i : i[e] || (i[e] = {}), m = h ? r : p ? r[e] : (r[e] || {})[s];
                    h && (n = e);
                    for (c in n)u = !f && m && c in m, u && c in y || (l = u ? m[c] : n[c], y[c] = h && "function" != typeof m[c] ? n[c] : v && u ? o(l, r) : b && m[c] == l ? function (t) {
                        var e = function (e) {
                ...
                var r = n(3).setDesc, i = n(18), o = n(1)("toStringTag");
                t.exports = function (t, e, n) {
                    t && !i(t = n ? t : t.prototype, o) && r(t, o, {configurable: !0, value: e})
                }
            }, function (t, e, n) {
                var r = n(8), i = n(1)("toStringTag"), o = "Arguments" == r(function () {
                        return arguments
                    }());
                t.exports = function (t) {
                    var e, n, s;
                ...
                "use strict";
                var r = n(20), i = n(13), o = n(22), s = n(14), a = n(18), c = n(7), u = n(45), l = n(15), f = n(3).getProto, h = n(1)("iterator"), p = !([].keys && "next" in [].keys()), d = "@@iterator", v = "keys", b = "values", y = function () {
                    return this
                };
                t.exports = function (t, e, n, m, _, g, x) {
                    ...
                    if ($) {
                        ...
                        l(j, k, !0), !r && a(T, d) && s(j, h, y), C && $.name !== b && (O = !0, A = function () {
                            return $.call(this)
                        })
                    }
                    if (r && !x || !p && !O && T[h] || s(T, h, A), c[e] = A, c[k] = y, _)if (E = {
                            values: C ? A : w(b),
                            keys: g ? A : w(v),
                            entries: C ? w("entries") : A
                        }, x)for (S in E)S in T || o(T, S, E[S]); else i(i.P + i.F * (p || O), e, E);
                    return E
                }
            }, function (t, e) {
                t.exports = !0
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), e["default"] = function () {
                    $.fn.blScrollable = function () {
                        if (this.length) {
                            if (this.length > 1)return void this.each(function () {
                                $(this).blScrollable()
                            });
                            var t = this;
                            if (t.addClass("simplebar"), t.data("horizontal") && t.addClass("horizontal"), void 0 === $.fn.simplebar)return void t.css("overflow-y", "scroll");
                            t.simplebar(), t.simplebar().on("scroll", function () {
                                var t = $(this), e = t.simplebar("getScrollElement").scrollTop();
                                $("body").trigger("scrolling.bl.scrollable", [e]), clearTimeout(this.scrollTimer), this.scrollTimer = setTimeout(function () {
                                ...
                                n && t.simplebar("getScrollElement").animate({scrollTop: n.offsetTop})
                            })
                        }
                    }, $("[data-scrollable]").blScrollable()
                }, n(81), t.exports = e["default"]
            }, function (t, e, n) {
                "use strict";
                function r(t) {
                    return t && t.__esModule ? t : {"default": t}
                ...
                var i = n(30), o = r(i), s = n(29), a = r(s), c = n(31), u = r(c), l = n(32), f = r(l), h = n(24), p = r(h), d = n(72), v = r(d);
                n(33);
                var b = function () {
                    function t() {
                        (0, u["default"])(this, t), this.SCREEN_SIZE = null, this.SCREEN_MD_UP = null, this.UPDATE_SCREEN_DEBOUNCE = 30, this.BREAKPOINTS = {
                            320: ["xs", "xs-up"],
                            480: ["xs", "xs-up"],
                            544: ["sm", "sm-up"],
                            768: ["md", "md-up"],
                            ...
                            1200: ["xl", "xl-up"],
                            1600: ["xl", "xl-up"]
                        }, this.VISIBLE_CLASS = "sidebar-visible", this.EVENTS_CONTAINER = "body", this.LAYOUT_CONTAINER_SELECTOR = ".layout-container", this.SELECTOR = ".sidebar", this.TOGGLE_SELECTOR = "[data-toggle=sidebar]", this.NAV_SELECTOR = ".sidebar-menu", this.NAV_ITEM_SELECTOR = ".sidebar-menu-item", this.NAV_BUTTON_SELECTOR = ".sidebar-menu-button", this._updateScreenDebounce = null
                    }

                    return (0, f["default"])(t, [{
                        key: "_options", value: function (t) {
                            t = this._sidebar(t);
                            var e = t.data("position") || "left", n = (t.data("size") || 3) + "", r = e.charAt(0), i = t.data("visible") || "md-up", o = t.attr("id");
                            return {id: o, position: e, direction: r, size: n, visible: i}
                        }
                    }, {
                        key: "_breakpoints", value: function () {
                            return (0, a["default"])(this.BREAKPOINTS).map(function (t) {
                                return parseInt(t, 10)
                            })
                        }
                    }, {
                        key: "_visibleBreakpointsFor", value: function (t) {
                            var e = this, n = [];
                            return this._visibleOptions(t).map(function (t) {
                                (0, p["default"])(e.BREAKPOINTS, function (e, r) {
                                    -1 !== e.indexOf(t) && n.push(parseInt(r, 10))
                                })
                            }), n
                        }
                    }, {
                        key: "_setBreakpoint", value: function (t, e, n) {
                            $(window)[t ? "off" : "on"]("enterBreakpoint" + e, n.bind(this))
                        }
                    }, {
                        key: "_setBreakpointsFor", value: function (t, e) {
                            var n = this;
                            t = this._sidebar(t);
                            var r = this._breakpoints(), i = this._visibleBreakpointsFor(t);
                            (0, p["default"])(this.BREAKPOINTS, function (o, s, a) {
                                n._visibleOptions(t).forEach(function (a) {
                                    if (-1 !== o.indexOf(a)) {
                                        var c = -1 !== a.indexOf("up"), u = r.filter(function (t) {
                                            return t > s
                                        }), l = parseInt(s, 10);
                                        ...
                                        c ? (u.unshift(s), u.filter(function (t) {
                                            return -1 === i.indexOf(t)
                                        }).forEach(function (r) {
                                            n._setBreakpoint(e, r, function () {
                                                return n.show(t, !1)
                        ...
                        key: "_triggerBreakpointsFor", value: function (t) {
                            var e = this;
                            return t = this._sidebar(t), new o["default"](function (n) {
                                e._updateScreen(function () {
                                    for (var r = e._visibleBreakpointsFor(t).sort(function (t, e) {
                                        ...
                                        var o = r[i];
                                        if (e.SCREEN_SIZE >= o) {
                                            $(window).trigger("enterBreakpoint" + o), n();
                                            break
                                        }
                                    }
                                })
                        ...
                        key: "_initBreakpoints", value: function (t) {
                            var e = this;
                            "undefined" == typeof $.fn.setBreakpoints || t || $(window).setBreakpoints({breakpoints: this._breakpoints()}), this._each(function (n) {
                                return e._setBreakpointsFor(n, t)
                            })
                        }
                    }, {
                        key: "_classString", value: function (t) {
                            return t.join(" ")
                        }
                    }, {
                        key: "_layoutClasses", value: function (t) {
                            var e = this, n = this._options(t), r = [], i = [];
                            return this._sizeOptions(t).map(function (t) {
                                var e = t.match(/([a-zA-Z-]+)/gi);
                                e && (e = e.pop().replace(/^\-/, ""), i.push(e))
                            }), this._visibleOptions(t).map(function (o) {
                                e._sizeOptions(t).map(function (t) {
                                    var e = "si-" + n.direction + t, s = t.match(/([a-zA-Z-]+)/gi);
                                    s && (s = s.pop().replace(/^\-/, "")), -1 !== t.indexOf(o) || s || (e = e + "-" + o), -1 !== i.indexOf(o) && (e = null), e && r.push(e)
                                })
                            }), (0, v["default"])(r)
                        }
                    }, {
                        key: "_sidebarClasses", value: function (t) {
                            var e = this._options(t), n = ["sidebar-" + e.position], r = this._sizeOptions(t).map(function (t) {
                                return "si-si-" + t
                            });
                            return n.concat(r)
                        }
                    }, {
                        key: "_sizeOptions", value: function (t) {
                            var e = this._options(t);
                            return e.size.split(" ")
                        }
                    }, {
                        key: "_visibleOptions", value: function (t) {
                            var e = this._options(t);
                            return "none" === e.visible ? [] : e.visible.split(" ")
                        }
                    }, {
                        key: "_emit", value: function (t, e) {
                            $(this.EVENTS_CONTAINER).trigger(t + ".bl.sidebar", [e])
                        }
                    }, {
                        key: "_layout", value: function (t) {
                            return t = this._sidebar(t), t.closest(this.LAYOUT_CONTAINER_SELECTOR)
                        }
                    }, {
                        key: "toggle", value: function (t) {
                            t = this._sidebar(t), t.hasClass(this.VISIBLE_CLASS) ? this.hide(t) : this.show(t)
                        }
                    }, {
                        key: "show", value: function (t) {
                            var e = this, n = arguments.length <= 1 || void 0 === arguments[1] ? !0 : arguments[1];
                            t = this._sidebar(t);
                            var r = this.VISIBLE_CLASS, i = this._options(t);
                            if (this._emit("show", i), this._layout(t).addClass(this._classString(this._layoutClasses(t))), !t.hasClass(r)) {
                                if (n)return t.addClass("sidebar-transition"), setTimeout(function () {
                                    t.addClass(r), e._emit("shown", i)
                                }, 10);
                                t.addClass(r), this._emit("shown", i)
                            }
                        }
                    }, {
                        key: "hide", value: function (t) {
                            var e = this;
                            t = this._sidebar(t);
                            var n = this.VISIBLE_CLASS, r = t.attr("class").match(new RegExp(n + "([a-z-]+)?", "ig")), i = this._options(t);
                            this._layout(t).removeClass(this._classString(this._layoutClasses(t))), t.hasClass(n) && (this._emit("hide", i), t.removeClass(this._classString(r)), t.hasClass("sidebar-transition") ? setTimeout(function () {
                                t.removeClass("sidebar-transition"), e._emit("hidden", i)
                            }, 450) : this._emit("hidden", i))
                        }
                    }, {
                        key: "_sidebar", value: function (t) {
                            return t instanceof jQuery == 1 ? t : $(t)
                        }
                    }, {
                        key: "_each", value: function (t) {
                            var e = this;
                        ...
                        key: "_updateScreen", value: function (t) {
                            var e = this;
                            clearTimeout(this._updateScreenDebounce), this._updateScreenDebounce = setTimeout(function () {
                                e.SCREEN_SIZE = $(window).width(), e.SCREEN_MD_UP = $(window).width() >= 768, "function" == typeof t && t()
                            }, this.UPDATE_SCREEN_DEBOUNCE)
                        }
                    }, {
                        key: "init", value: function () {
                            var t = this;
                            this._initBreakpoints(), $(this.EVENTS_CONTAINER).on("show.bl.sidebar", function (e, n) {
                                if (n) {
                            ...
                            }), this._updateScreen(), $(window).resize(this._updateScreen.bind(this)), $(this.NAV_BUTTON_SELECTOR).on("click", function (e) {
                                var n = $(e.currentTarget);
                                if (n.next("ul").html()) {
                                    e.preventDefault();
                                    var r = n.parent();
                                    if (r.hasClass("open"))r.removeClass("open"); else {
                                        var i = n.closest(t.NAV_SELECTOR), o = i.find(t.NAV_ITEM_SELECTOR + ".open");
                                        o.removeClass("open"), r.addClass("open")
                                    }
                                }
                ...
                !function (t) {
                    ...
                    t.fn.resetBreakpoints = function () {
                        ...
                        var i = jQuery.extend({distinct: !0, breakpoints: new Array(320, 480, 768, 1024)}, r);
                        n = setInterval(function () {
                            var n = t(window).width(), r = !1;
                                ...
                                if (!r && n >= i.breakpoints[o] && e < i.breakpoints[o]) {
                                    if (i.distinct) {
                                        for (var s in i.breakpoints.sort(function (t, e) {
                                            return e - t
                                        }))t("body").hasClass("breakpoint-" + i.breakpoints[s]) && (t("body").removeClass("breakpoint-" + i.breakpoints[s]), t(window).trigger("exitBreakpoint" + i.breakpoints[s]));
                                        r = !0
                                    }
                                    t("body").addClass("breakpoint-" + i.breakpoints[o]), t(window).trigger("enterBreakpoint" + i.breakpoints[o])
                                }
                ...
                n(65), t.exports = n(4).Object.keys
            }, function (t, e, n) {
                n(66), n(68), n(69), n(67), t.exports = n(4).Promise
            }, function (t, e) {
                t.exports = function () {
                }
            }, function (t, e, n) {
                var r = n(9), i = n(2).document, o = r(i) && r(i.createElement);
                t.exports = function (t) {
                    return o ? i.createElement(t) : {}
                }
            }, function (t, e, n) {
                var r = n(6), i = n(44), o = n(43), s = n(5), a = n(60), c = n(63);
                t.exports = function (t, e, n, u) {
                    var l, f, h, p = c(t), d = r(n, u, e ? 2 : 1), v = 0;
                    if ("function" != typeof p)throw TypeError(t + " is not iterable!");
                    if (o(p))for (l = a(t.length); l > v; v++)e ? d(s(f = t[v])[0], f[1]) : d(t[v]); else for (h = p.call(t); !(f = h.next()).done;)i(h, d, f.value, e)
                }
            }, function (t, e, n) {
                ...
                "use strict";
                var r = n(3), i = n(21), o = n(15), s = {};
                n(14)(s, n(1)("iterator"), function () {
                    return this
                }), t.exports = function (t, e, n) {
                    t.prototype = r.create(s, {next: i(1, n)}), o(t, e + " Iterator")
                }
            }, function (t, e, n) {
                ...
                if (f)o = function () {
                    ...
                    new c(h).observe(d, {characterData: !0}), o = function () {
                        d.data = p = -p
                    }
                ...
                t.exports = function (t) {
                    var e = {fn: t, next: void 0, domain: f && u.domain};
                    i && (i.next = e), r || (r = e, o()), i = e
                }
            }, function (t, e, n) {
                var r = n(13), i = n(4), o = n(17);
                t.exports = function (t, e) {
                ...
                var r = n(3).getDesc, i = n(9), o = n(5), s = function (t, e) {
                    if (o(t), !i(e) && null !== e)throw TypeError(e + ": can't set as prototype!")
                };
                t.exports = {
                    set: Object.setPrototypeOf || ("__proto__" in {} ? function (t, e, i) {
                        try {
                            i = n(6)(Function.call, r(Object.prototype, "__proto__").set, 2), i(t, []), e = !(t instanceof Array)
                        } catch (o) {
                            e = !0
                        }
                        return function (t, n) {
                ...
                "use strict";
                var r = n(4), i = n(3), o = n(12), s = n(1)("species");
                t.exports = function (t) {
                    var e = r[t];
                ...
                var r = n(5), i = n(10), o = n(1)("species");
                t.exports = function (t, e) {
                ...
                var r, i = n(3), o = n(20), s = n(2), a = n(6), c = n(16), u = n(13), l = n(9), f = n(5), h = n(10), p = n(56), d = n(39), v = n(52).set, b = n(51), y = n(1)("species"), m = n(55), _ = n(48), g = "Promise", x = s.process, E = "process" == c(x), S = s[g], w = function (t) {
                    ...
                    var e = !1;
                    try {
                        if (e = S && S.resolve && w(), v(t, S), t.prototype = i.create(S.prototype, {constructor: {value: t}}), t.resolve(5).then(function () {
                            }) instanceof t || (e = !1), e && n(12)) {
                            var r = !1;
                    ...
                    if (!t.n) {
                        ...
                        _(function () {
                            for (var r = t.v, i = 1 == t.s, o = 0, a = function (e) {
                                ...
                                try {
                                    s ? (i || (t.h = !0), n = s === !0 ? r : s(r), n === e.promise ? c(TypeError("Promise-chain cycle")) : (o = T(n)) ? o.call(n, a, c) : a(n)) : c(r)
                                } catch (u) {
                                    c(u)
                                }
                            }; n.length > o;)a(n[o++]);
                ...
                k || (S = function (t) {
                    h(t);
                    var e = this._d = {p: p(this, S, g), c: [], a: void 0, s: 0, d: !1, v: void 0, h: !1, n: !1};
                    try {
                        t(a(B, e, 1), a(P, e, 1))
                    } catch (n) {
                        P.call(e, n)
                    ...
                    then: function (t, e) {
                        var n = new $(m(this, S)), r = n.promise, i = this._d;
                        return n.ok = "function" == typeof t ? t : !0, n.fail = "function" == typeof e && e, i.c.push(n), i.a && i.a.push(n), i.s && j(i, !1), r
                    }, "catch": function (t) {
                        return this.then(void 0, t)
                    }
                })), u(u.G + u.W + u.F * !k, {Promise: S}), n(15)(S, g), n(53)(g), r = n(4)[g], u(u.S + u.F * !k, g, {
                    reject: function (t) {
                        var e = new $(this), n = e.reject;
                        return n(t), e.promise
                    }
                }), u(u.S + u.F * (!k || w(!0)), g, {
                    resolve: function (t) {
                        if (t instanceof S && C(t.constructor, this))return t;
                        var e = new $(this), n = e.resolve;
                        return n(t), e.promise
                    }
                    ...
                    all: function (t) {
                        var e = O(this), n = new $(e), r = n.resolve, o = n.reject, s = [], a = A(function () {
                            d(t, !1, s.push, s);
                            var n = s.length, a = Array(n);
                        ...
                        var e = O(this), n = new $(e), r = n.reject, i = A(function () {
                            d(t, !1, function (t) {
                ...
                function r(t, e) {
                    return e = e || i, o(t, function (t, n, r) {
                ...
                var r = n(77), i = Array.isArray || function (t) {
                        return r(t, "Array")
                    };
                t.exports = i
            }, function (t, e, n) {
                ...
                function r(t, e) {
                    for (var n = -1, r = t.length; ++n < r;)if (s(t[n], e))return !0;
                    return !1
                }

                function i(t, e) {
                    for (var n = -1, i = e.length; ++n < i;)if (!r(t, e[n]))return !1;
                    return !0
                }
                ...
                function i(t, e, n) {
                    var i, u = 0;
                    null == s && r();
                    for (i in t)if (o(e, t, i, n) === !1)break;
                    if (s)for (var l = t.constructor, f = !!l && t === l.prototype; (i = a[u++]) && ("constructor" === i && (f || !c(t, i)) || t[i] === Object.prototype[i] || o(e, t, i, n) !== !1););
                }
                ...
                !function (e) {
                    ...
                    function i() {
                        var e = t('<div class="scrollbar-width-tester" style="width:50px;height:50px;overflow-y:scroll;top:-200px;left:-200px;"><div style="height:100px;"></div>'), n = 0, r = 0;
                        return t("body").append(e), n = t(e).innerWidth(), r = t("div", e).innerWidth(), e.remove(), n - r
                    }

                    function o(e, n) {
                        this.el = e, this.$el = t(e), this.$track, this.$scrollbar, this.dragOffset, this.flashTimeout, this.$contentEl = this.$el, this.$scrollContentEl = this.$el, this.scrollDirection = "vert", this.scrollOffsetAttr = "scrollTop", this.sizeAttr = "height", this.scrollSizeAttr = "scrollHeight", this.offsetAttr = "top", this.options = t.extend({}, o.DEFAULTS, n), this.theme = this.options.css, this.init()
                    }
                    ...
                    o.DEFAULTS = {
                        ...
                        e.preventDefault();
                        var r = e.pageY;
                        "horiz" === this.scrollDirection && (r = e.pageX), this.dragOffset = r - this.$scrollbar.offset()[this.offsetAttr], t(n).on("mousemove", t.proxy(this.drag, this)), t(n).on("mouseup", t.proxy(this.endDrag, this))
                    }, o.prototype.drag = function (t) {
                        t.preventDefault();
                        var e = t.pageY, n = null, r = null, i = null;
                        "horiz" === this.scrollDirection && (e = t.pageX), n = e - this.$track.offset()[this.offsetAttr] - this.dragOffset, r = n / this.$track[this.sizeAttr](), i = r * this.$contentEl[0][this.scrollSizeAttr], this.$scrollContentEl[this.scrollOffsetAttr](i)
                    }, o.prototype.endDrag = function () {
                        t(n).off("mousemove", this.drag), t(n).off("mouseup", this.endDrag)
                    }, o.prototype.resizeScrollbar = function () {
                        if (0 !== s) {
                            var t = this.$contentEl[0][this.scrollSizeAttr], e = this.$scrollContentEl[this.scrollOffsetAttr](), n = this.$track[this.sizeAttr](), r = n / t, i = Math.round(r * e) + 2, o = Math.floor(r * (n - 2)) - 2;
                            t > n ? ("vert" === this.scrollDirection ? this.$scrollbar.css({
                                top: i,
                                height: o
                            }) : this.$scrollbar.css({left: i, width: o}), this.$track.show()) : this.$track.hide()
                        }
                        ...
                        a || ("vert" === this.scrollDirection ? (this.$scrollContentEl.width(this.$el.width() + s), this.$scrollContentEl.height(this.$el.height())) : (this.$scrollContentEl.width(this.$el.width()), this.$scrollContentEl.height(this.$el.height() + s)))
                    ...
                    t.fn.simplebar = function (e) {
                        ...
                        return "undefined" == typeof e || "object" == typeof e ? this.each(function () {
                            ...
                            r instanceof o && "function" == typeof r[e] && (n = r[e].apply(r, Array.prototype.slice.call(i, 1))), "destroy" === e && t.data(this, "simplebar", null)
                        }), n !== r ? n : this) : void 0
                    }, t.fn.simplebar.Constructor = o, t.fn.simplebar.noConflict = function () {
                        return t.fn.simplebar = c, this
                    }
                })
            }, function (e, n) {
                e.exports = t
