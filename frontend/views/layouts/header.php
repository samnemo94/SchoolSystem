...
<nav class="navbar navbar-dark bg-primary navbar-full navbar-fixed-top">
    ...
    <!-- Toggle sidebar -->
    <button class="navbar-toggler pull-xs-<?= Yii::$app->language == "ar"?"right":"left" ?>" type="button" data-toggle="sidebar" data-target="#sidebarLeft"><span class="material-icons">menu</span></button>
    ...
    <ul class="nav navbar-nav pull-xs-<?= Yii::$app->language == "ar"?"left":"right" ?>">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-<?= Yii::$app->language == "ar"?"left":"right" ?> dropdown-menu-list" aria-labelledby="Preview">
